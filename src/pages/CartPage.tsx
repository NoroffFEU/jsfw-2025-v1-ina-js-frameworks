...
function CartPage() {
  ...
  return (
    <div className="flex justify-center">
      <div className="flex max-[840px]:flex-col min-h-screen max-w-[1600px] w-full">
        <div className="flex-1 px-4 md:px-10 mt-[100px] pb-6">
          ...
          <div className="flex flex-col gap-7">
            {items.length === 0 && (
              <div className="flex flex-col items-center text-blue-800 mt-10">
                ...
                <p className="text-[32px] my-5 font-bold">
                  Your cart is empty.
                </p>
                <Link
                  to={"/"}
        ...
        {items.length > 0 && (
          <div className="px-4 md:px-10 pt-[100px] pb-6 bg-blue-100 w-[380px] max-[840px]:w-full">
